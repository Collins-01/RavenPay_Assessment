...
import 'package:raven_pay_assessment/features/home/data/models/candle_ticker_model.dart';
import 'package:raven_pay_assessment/features/home/data/models/order_book_model.dart';
import 'package:raven_pay_assessment/features/home/presentation/controllers/chart_controller.dart';
import 'package:raven_pay_assessment/features/home/repositories/binance_repository.dart';
...
final socketController = StreamProvider.family<CandleTickerModel, StreamValue?>(
  ...
  await for (final String value in channel.stream) {
    // print('Value from from stream == $value');
